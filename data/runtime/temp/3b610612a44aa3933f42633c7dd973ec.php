<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:50:"./application/admin/template/shop_product\edit.htm";i:1596507477;s:60:"D:\wwwroot\test\application\admin\template\public\layout.htm";i:1596507477;s:56:"D:\wwwroot\test\application\admin\template\shop\left.htm";i:1590716805;s:78:"D:\wwwroot\test\application\admin\template\archives\get_field_addonextitem.htm";i:1596507476;s:60:"D:\wwwroot\test\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="min-width:auto; margin-left:98px;">
    <div class="flexigrid">
        ...
        <form class="form-horizontal" id="post_form" action="<?php echo url('ShopProduct/edit'); ?>" method="post">
            <!-- 常规信息 -->
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#typeid').change(function(){
            ...
            GetAddonextitem($(this).val(), <?php echo $channeltype; ?>, <?php echo $aid; ?>, true);
        });
    });
    ...
    function ClearPicArr2(obj,path)
    {
        ...
        $.ajax({
            type:'POST',
            url:"<?php echo url('ShopProduct/del_proimg'); ?>",
    ...
    function get_attr_input()
    {
        ...
        $.ajax({
            ...
            url:"<?php echo url('ShopProduct/ajax_get_attr_input'); ?>",
            success:function(data){
