<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"./application/admin/template/shop_product\attrlist_index.htm";i:1583307753;s:60:"D:\wwwroot\test\application\admin\template\public\layout.htm";i:1596507477;s:56:"D:\wwwroot\test\application\admin\template\shop\left.htm";i:1590716805;s:60:"D:\wwwroot\test\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<body style="overflow: auto; cursor: default; -moz-user-select: inherit;background-color:#F4F4F4; padding: 20px; ">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form id="searchForm" class="navbar-form form-inline" action="<?php echo U('ShopProduct/attrlist_index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
                ...
                <div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
                    <table style="width: 100%;">
                        ...
                        <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                            <tr class="tr">
                                <td class="sign">
                                    <div class="tc w40"><input type="checkbox" name="ids[]" value="<?php echo $vo['list_id']; ?>"></div>
                                </td>
                                ...
                                <td>
                                    <div class="w180 tc">
                                        <?php if(is_check_access(CONTROLLER_NAME.'@attribute_edit') == '1'): ?>
                                            <a href="<?php echo U('ShopProduct/attribute_index',array('list_id'=>$vo['list_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>参数值管理</a>
                                        <?php endif; if(is_check_access(CONTROLLER_NAME.'@attrlist_del') == '1'): ?>
                                            <a class="btn red"  href="javascript:void(0);" data-url="<?php echo U('ShopProduct/attrlist_del'); ?>" data-id="<?php echo $vo['list_id']; ?>" onclick="DelFind(this);"><i class="fa fa-trash-o"></i>删除</a>
                                        <?php endif; ?>
                                    </div>
                                </td>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <?php if(is_check_access(CONTROLLER_NAME.'@attrlist_del') == '1'): ?>
                    <div class="fbutton">
                        <a onclick="DelBatch(this, 'ids');" data-url="<?php echo U('ShopProduct/attrlist_del'); ?>">
                ...
                <?php endif; if(is_check_access(CONTROLLER_NAME.'@attrlist_add') == '1'): ?>
                    ...
                    <div class="fbutton">
                        <a href="javascript:void(0);" data-url="<?php echo url('ShopProduct/attrlist_add', ['_ajax'=>1]); ?>" onclick="AddAttrListData(this);">
