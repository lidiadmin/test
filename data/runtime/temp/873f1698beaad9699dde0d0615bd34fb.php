<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:31:"./template/pc/view_business.htm";i:1599657237;s:38:"D:\wwwroot\test\template\pc\header.htm";i:1600351329;s:38:"D:\wwwroot\test\template\pc\banner.htm";i:1571728724;s:38:"D:\wwwroot\test\template\pc\footer.htm";i:1600351311;}*/ ?>
<!doctype html>
<html>
<head>
<!--此模板为自定义新增企业模型详情模板-->
...
<ol class="am-breadcrumb">
  ...
  <div class="job_show">
    ...
    <div class="info">
      <ul>
        <li style="width: auto;"><span>主营业务：</span><?php echo $eyou['field']['i_business']; ?></li>
        <li><span>联系地址：</span><?php echo $eyou['field']['i_address']; ?></li>
        <li><span>企业网站：</span><?php echo $eyou['field']['i_url']; ?></li>
        <li><span>联系人：</span><?php echo $eyou['field']['i_contacts']; ?></li>
        <li><span>联系电话：</span><?php echo $eyou['field']['i_phone']; ?></li>
        <li><span>发布日期：</span><?php echo MyDate('Y-m-d',$eyou['field']['add_time']); ?></li>
        <li><span>点击数：</span><?php  if(!isset($aid) || empty($aid)) : $aid = "0"; endif; $tagArcclick = new \think\template\taglib\eyou\TagArcclick; $__VALUE__ = $tagArcclick->getArcclick($aid, "", ""); echo $__VALUE__; ?></li>
      </ul>
    </div>
    <div class="clear"></div>
    <div class="intro">
     <!--文章主体——自定义字段-->
      <?php echo $eyou['field']['introduce']; ?> 
      <div class="clear"></div>
    </div>
    <!--上下篇——开始-->
    <div class="prenext">
  ...
  <div class="subject m20"> <b>其他企业</b> </div>
  ...
  'row' => '6',
    ...
    <li>
	  ...
	  <div class="txt">
		<a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>"><?php echo $field['title']; ?></a><?php echo html_msubstr($field['seo_description'],0,120,true); ?>
	  </div>
	</li>
